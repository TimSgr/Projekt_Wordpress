...
function my_functions() {
    ...
    wp_register_style( 'theme-style', get_stylesheet_directory_uri() . '/css/main.css');
...
// Register Testmonials
function testmonials() {

	$labels = array(
		'name'                  => 'Post Types',
		'singular_name'         => 'Post Type',
		'menu_name'             => 'Testmonials',
		'name_admin_bar'        => 'Post Type',
		'archives'              => 'Item Archives',
		'attributes'            => 'Item Attributes',
		'parent_item_colon'     => 'Parent Item:',
	...
	register_post_type( 'testmonial_post_type', $args );

}
add_action( 'init', 'testmonials', 0 );
